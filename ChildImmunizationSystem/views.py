...
def send_notifications(request):
    ...
    notifications = ben_models.Notification.objects.all().filter(is_sent__exact=False, scheduled_date__exact=datetime.date.today(), child_vaccine__child__parent__user__first_name__iexact='anikate')
    for notification in notifications:
        email_list = [notification.child_vaccine.child.parent.user.email, notification.child_vaccine.child.parent.medical_helper.user.email, 'adityakumar2809@gmail.com']
